...
- For each pvin in the response, create a Markdown with the URL for the pvin as the following [pvin](https://honkda.staging.pull.systems/vehicle/$pvin)
- For each fault code inthe response, create a Markdown with the URL for the fault code as the following [fault code](https://honkda.staging.pull.systems/vehicle/$faultCode)
